...
//Ispis svih pacijenata iz niza 1. naciin, A MOZE I FOR PETLJOM POMOCU INDEKSA
...
//Ispis svih pacijenata koji su laksi od 50kg
foreach($pacijentiNiz as $obj){
    if($obj->getTezina() < 50){
        $obj->stampaj();
    }
...
echo "<p>Prosecna visina svih pacijenata je $prosecnaVisina.</p>";

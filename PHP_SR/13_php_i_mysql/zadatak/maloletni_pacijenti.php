...
<head>
    ...
    <title>Maloletni pacijenti</title>
...
<body>
    ...
    <section>   
        <?php
            ...
            WHERE YEAR(CURDATE()) - YEAR(datum_rodjenja) < 18;";
            // Ispravnije resenje je ovo sa TIMESTAMPDIFF
            // SELECT * FROM `pacijenti`
            // WHERE TIMESTAMPDIFF(YEAR, datum_rodjenja, CURDATE()) <18;
            $result = $conn->query($q);
            if($result->num_rows){
